...
public class MainActivity extends AppCompatActivity {
    ...
    public void goToPage() {
        CardView cityCard = findViewById(R.id.cardViewKids);
        ...
        CardView readMore = findViewById(R.id.feed_card_other_blog1);
        ...
        CardView readMore2 = findViewById(R.id.feed_card_other_blog2);
        ...
        CardView readMore3 = findViewById(R.id.feed_card_other_blog3);
    ...
    public void goToPageRead(Blog blogVaule){
        ...
        Button btnReadMoreBlog = findViewById(R.id.readMoreBlog);
