...
public class ReasonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageButton imageButton = findViewById(R.id.reason_card1);
        ...
        final ImageButton imageButton1 = findViewById(R.id.reason_card2);
        ...
        Button btn = findViewById(R.id.btn_to_kid_result);
